	  ...
	  <div class="span_11">
		<div class="col-md-6 col_4">
		  <!----Calender -------->
			<link rel="stylesheet" href="<?=base_url()?>assets/backend/css/clndr.css" type="text/css" />
			<script src="<?=base_url()?>assets/backend/js/underscore-min.js" type="text/javascript"></script>
			<script src= "<?=base_url()?>assets/backend/js/moment-2.2.1.js" type="text/javascript"></script>
			<script src="<?=base_url()?>assets/backend/js/clndr.js" type="text/javascript"></script>
			<script src="<?=base_url()?>assets/backend/js/site.js" type="text/javascript"></script>
			<!----End Calender -------->
		</div>
